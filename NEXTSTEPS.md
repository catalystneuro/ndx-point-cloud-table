# Next Steps for ndx-point-cloud-table Extension for NWB:N

## Creating Your Extension

1. In a terminal, change directory into the new ndx-point-cloud-table directory.
...
4. Modify `src/create_extension_spec.py` to define your extension.
    ...
    - If you want to create any custom classes for interacting with the extension,
      ...
      - If present, the `src/pynwb` folder MUST contain the following:
        - `ndx-point-cloud-table` - Folder with the sources of the NWB extension
        - `ndx-point-cloud-table/__init__.py` - Python file that may be empty
...
`spec/ndx-point-cloud-table.namespace.yaml` and
`spec/ndx-point-cloud-table.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-point-cloud-table
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/bendichter/ndx-point-cloud-table/releases/tag/0.1.0

9. Publish your updated extension on PyPi.
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-point-cloud-table/0.1.0
...
`staged-extensions/ndx-point-cloud-table`:

    ```bash
cp -r staged-extensions/example staged-extensions/ndx-point-cloud-table
```

11. Edit `staged-extensions/ndx-point-cloud-table/ndx-meta.yaml`
...
version: 0.1.0
src: https://github.com/bendichter/ndx-point-cloud-table
pip: https://pypi.org/project/ndx-point-cloud-table/
license: BSD 3-Clause
maintainers:
  - bendichter
```

12. Edit `staged-extensions/ndx-point-cloud-table/README.md`
to add information about your extension. You may copy it from
`ndx-point-cloud-table/README.md`.

  ```bash
cp ndx-point-cloud-table/README.md staged-extensions/ndx-point-cloud-table/README.md
```
...
ndx-point-cloud-table-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-point-cloud-table GitHub repository.

2. Publish your updated extension on PyPi.

3. Fork the ndx-point-cloud-table-feedstock repository on GitHub.
