...
# -*- coding: utf-8 -*-
#
# ndx-point-cloud-table documentation build configuration file, created by
# sphinx-quickstart on Sun Dec 29 16:08:11 2019.
#
...
htmlhelp_basename = 'ndx-point-cloud-tabledoc'
...
latex_documents = [
    (master_doc, 'ndx-point-cloud-table.tex', 'ndx-point-cloud-table Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-point-cloud-table', 'ndx-point-cloud-table Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-point-cloud-table', 'ndx-point-cloud-table Documentation',
     author, 'ndx-point-cloud-table', 'One line description of project.',
     'Miscellaneous'),
]
